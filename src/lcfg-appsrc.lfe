...
(defun get-max-t (config)
  (lcfg-util:set-default
    (lcfg:get-in config '(project app max-t))
    'infinity))

(defun get-registered (config)
  (lcfg-util:set-default
    (lcfg:get-in config '(project app registered))
    '()))

(defun get-included-applications (config)
  (lcfg-util:set-default
    (lcfg:get-in config '(project app included-applications))
    '()))

(defun get-applications (config)
  (lcfg-util:set-default
    (lcfg:get-in config '(project app applications))
    '()))
...
(defun get-mod (config)
  (lcfg-util:set-default
    (lcfg:get-in config '(project app mod))
    '()))
